...
$string['activetablabel'] = 'Active ({$a})';
$string['adduser'] = '+ Add User';
$string['addusers'] = 'Add Users';
$string['addusersbutton'] = '+ Add Users';
$string['additionrequest'] = 'User addition';
$string['allroles'] = 'All roles';
$string['allusers'] = 'All Users';
$string['backtoactivity'] = 'Return to activity';
$string['bulkimportcsv'] = 'Bulk Import CSV';
$string['bulkimportcsvtab'] = 'Bulk Import (CSV)';
$string['bulkimporthelp'] = 'Upload a .csv or .xlsx file with email, first name, and last name columns.';
...
$string['invalidrole'] = 'Choose a valid role.';
$string['manualadditionfilename'] = 'Single user request';
$string['manualadditionvalidationmessage'] = 'Single user request for {$a}.';
$string['manualentry'] = 'Manual Entry';
$string['missingfile'] = 'File missing';
$string['missingfirstname'] = 'Enter a first name.';
$string['missingheaderrow'] = 'The spreadsheet must have a header row.';
$string['missinglastname'] = 'Enter a last name.';
...
$string['nousersmatchfilters'] = 'No users or requests match those filters.';
...
$string['filterbyrole'] = 'Filter by role';
$string['searchusers'] = 'Search users';
$string['searchusersplaceholder'] = 'Search by name or email';
$string['showingusers'] = 'Showing {$a->start} to {$a->end} of {$a->total} users';
$string['singleuserrequestfailed'] = 'The user request needs changes before it can be submitted.';
$string['singleusersubmittedmessage'] = 'Your user request has been submitted. Please allow us 48 hours to process it.';
...
$string['submittedmessage'] = 'Your spreadsheet has been submitted. Please allow us 48 hours to process it.';
...
$string['userorrequest'] = 'User / Request';
$string['useradditions'] = 'User additions';
$string['userstatusviews'] = 'User status views';
...
$string['viewuploadhistory'] = 'View Upload History';
